-- Instructions:
-- Access beeline
-- Copy Hive VW JDBC URL and connect via beeline (syntax: !connect <JDBC_URL>)
-- Execute this script (syntax: !run /<PATH>/hive_jdbc_test.sql)
...
SELECT
  'HIVE_JDBC_TEST_1' as test_name, IF (cnt > 0, 'SUCCESS', 'FAILURE') AS test_result, current_timestamp as test_time
FROM (
