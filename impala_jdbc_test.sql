-- Instructions:
-- Access impala-shell
-- Copy impala-shell command from Impala VW and execute
-- Execute this script (syntax: source /<PATH>/impala_jdbc_test.sql)
...
SELECT
  'IMPALA_JDBC_TEST_1' as test_name, IF (cnt > 0, 'SUCCESS', 'FAILURE') AS test_result, now() as test_time
FROM (
